...
@Component
public class RealDataWebSocketSessionCache {
    @Autowired
    RedisUtil redisUtil;

    final String sessionKey = "RealDataWebSocketSessionCache.websocketsession";

    final String sessionKey_group = "RealDataWebSocketSessionCache.websocketsession.group";
